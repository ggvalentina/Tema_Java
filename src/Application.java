...
public class Application {
    ...
    public void createNewUser(User user) throws Exception {
        userList.add(user);
        String line = user.userName.toString() + "," + user.password.toString() + "," + user.tip.toString() + ",";
        try (FileWriter fwriter = new FileWriter("users.csv", true);
    ...
    public void addLine(User user) throws Exception {
        String linie = user.fName.toString() + "+" + user.lName.toString() + "," + user.userName.toString() + "," + user.password.toString() + "," + user.tip.toString() + ",";
        try (FileWriter wr = new FileWriter("users.csv", true);
